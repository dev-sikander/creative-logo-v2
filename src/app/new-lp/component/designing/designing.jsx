                ...
                <div class="container mx-auto">
                    ...
                    <div class="grid grid-cols-1">
                      ...
                      <div className="mt-5 flex gap-x-7 justify-center">
                                <Link class="bg-[#dd1920] text-[#fff] py-3 px-9  rounded-full text-[16px] font-[600] hover:bg-[#ffff] hover:border-[1px]   hover:text-[#dd1920]" href="javascript:$zopim.livechat.window.show();">Live Chat</Link>
                                <Link onClick={openModal} class="bg-[#ffffff] text-[#dd1920] py-3 px-9  rounded-full text-[16px] font-[600]" href="javascript:;">Get Quote</Link>
                            </div>
